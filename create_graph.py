...
input_csv_name = ['data/parse_match_scores_1991-2016.csv', 'data/parse_match_scores_2017.csv']
...
out_path_G = ['data/Graph_atp_match_1991-2016.gexf', 'data/Graph_atp_match_2017.gexf']
out_path_sub_G = ['data/Graph_subGraph_atp_match_1991-2016.gexf', 'output/PR1_subGraph_atp_match_2017.gexf']


# create MultiDiGraph MDG
with open(input_csv_name[0], newline='') as inputFile:
...
nx.write_gexf(MDG, out_path_MDG[0])
nx.write_gexf(MG, out_path_MG[0])
nx.write_gexf(G, out_path_G[0])
